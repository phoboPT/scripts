...
def isAdmin(ctx):
    return ctx.author.id == 343714644147568650 or ctx.author.id == 686986610142740521 or ctx.author.id == 55841874546340659 or ctx.author.id == 619574286356578336 or ctx.author.id == 661953774734016512
